# SCS 0.5.0 — Governance & Compliance  
**Version:** 0.5.0 (Draft)  
...
SCS 0.5.0 requires tools to validate:
...
### 10.5 Compliance Completeness (Optional in 0.5.0)
...
The 0.5.0 model defines the minimum surface required for explainable, automatable governance.
