...
relationships:
  - type: aligns-with
    target: scd:meta:security-concepts
```
...
Cross-standard harmonization (e.g., mapping HIPAA → SOC2 → ISO) is encouraged but not required in 0.5.0.
